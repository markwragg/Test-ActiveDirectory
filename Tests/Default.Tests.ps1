...
$Scripts = Get-ChildItem "$PSScriptRoot\..\ADAudit" -Filter '*.ps1' -File -Recurse -Exclude '*.psdeploy.ps1','build.ps1','install.ps1','psake.ps1'
$Modules = Get-ChildItem "$PSScriptRoot\..\ADAudit" -Filter '*.psm1' -File -Recurse
